...
<div style="width: 640px;margin: auto;position: relative">
    <h1 class="mod-header index">微店</h1>
    <div style="position: relative;margin-left: 19px;">
        <a href="test.php"><img src="http://img.geilicdn.com/SBBqFCJ7ZmCrO5GeguEPDlryPyGEE42cSzqSlJ8ZDknGKb=_290x441.jpg"/></a>
